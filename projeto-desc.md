...
3. **Entidades/estruturas e algoritmos** a serem implementadas:
...
**4. Banco de Dados:**
    ...
    b. O banco exemplo servirá como base na validação dos nomes de tabelas e campos no
       momento da validação da cláusula SQL.
    c. Se desejarem criar o banco, no final desde documento foram fornecidos os Scripts para
       criação do banco de dados para o MySQL.
...
```
6. **Funcionamento:**
    a. A string com a consulta SQL é entrada na interface gráfica;
    b. A string é parseada e o comando SQL é validado;
    c. O comando SQL é convertido para álgebra relacional;
    d. A álgebra relacional é otimizada conforme as heurísticas solicitadas;
    e. O grafo de operadores é construído em memória;
    f. O grafo de operadores deve ser mostrado na Interface gráfica;
    g. O resultado da consulta mostrando cada operação e a ordem que será executada, é exibido
       na interface gráfica.
7. **Critérios de Avaliação:**

```
Critério Nota
Interface Gráfica Existente e funcional 1,
Existe local para inserir a string com a consulta SQL: 1,
A string é parseada 1,
Campos e comandos errados são validados 1,
O grafo Otimizado de operadores deve ser mostrado na GUI 1,
Ordem de execução da consulta deve ser mostrada (plano de
execução) 1,
Heurística Redução de Tuplas apresentada no grafo 1,
Heurística Redução de Atributos apresentada no grafo 1,
Demais Heurísticas 1,
Total 10,
```

Scripts SQL para criação do Banco Exemplo (Opcional) – Para conhecer os campos e tabelas para
usar no parse
